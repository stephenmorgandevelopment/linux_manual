...
//				((MainActivity_Legacy) requireActivity()).removePage(infoModel.getId());
//			}
...
//			text.removeSpan(SingleTextMatch.Companion.getBackgroundSpan());
//			text.removeSpan(SingleTextMatch.Companion.getForegroundColorSpan());
//		}
//	}
//
...
//
//		text.setSpan(
//				SingleTextMatch.Companion.getBackgroundSpan(),
//				textMatch.getIndex(),
//				infoModel.calcEndIndex(textMatch.getIndex()),
//				SpannableStringBuilder.SPAN_INCLUSIVE_INCLUSIVE);
//
//		text.setSpan(
//				SingleTextMatch.Companion.getForegroundColorSpan(),
//				textMatch.getIndex(),
//				infoModel.calcEndIndex(textMatch.getIndex()),
//				SpannableStringBuilder.SPAN_INCLUSIVE_INCLUSIVE);
//
