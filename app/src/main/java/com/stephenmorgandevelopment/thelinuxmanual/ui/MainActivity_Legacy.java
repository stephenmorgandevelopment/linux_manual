...
//
//		Helpers.init(MainActivity_Legacy.this.getApplication());
//		viewModel = new ViewModelProvider(MainActivity_Legacy.this).get(MainActivityViewModel.class);
//
...
//		super.onResume();
//
//		// TODO:  Replace 'DatabaseHelper.getInstance()' with injections.
//		if (DatabaseHelper.getInstance().hasDatabase() && DatabaseHelper.getInstance().hasData() && !CommandSyncService.isWorking()) {
...
//
//		pagerAdapter = new PrimaryPagerAdapter(MainActivity_Legacy.this, lookupFragment);
//
